...
_M.info = {
    ...
    ['POLICY_PARAMETER_ERROR']	= { 50203, 'policiy parameter for ' },
    
    --	redis connect error
    ['REDIS_PARAMETER_ERROR']   = { 50301, 'redis parameter error for '},
    ['REDIS_SOCK_ERROR']	    = { 50302, 'get cosocket error for '},
    ['REDIS_CONNECT_ERROR']	    = { 50303, 'redis connect error for '},
    ['REDIS_KEEPALIVE_ERROR']   = { 50304, 'redis keepalive error for '},
